// =============================================================================
// TradePhantoms_IOF_v3.cs — Master indicator integration (Path A full rebuild)
// =============================================================================
...
namespace TradePhantomsIOF
{
    ...
    /// </summary>
    public class TradePhantoms_IOF_v3 : Indicator, IVolumeAnalysisIndicator
    {
        // ---------------------------------------------------------------------
        // INPUTS — Detection
        // ---------------------------------------------------------------------
        ...
        // CONSTRUCTOR
        // ---------------------------------------------------------------------
        public TradePhantoms_IOF_v3() : base()
        {
            Name = "TradePhantoms IOF v3";
        ...
        protected override void OnInit()
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.HTFInit");
            }
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.DailyHistInit");
            }
            ...
            if (this.UseMTFZones && this.Symbol != null)
            {
                ...
                {
                    Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.MTFInit");
                }
            }
            ...
            if (this.LTFOverrideEnabled && this.Symbol != null)
            {
                ...
                {
                    Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.LTFInit");
                }
            }
            ...
            if (this.EnableTrendDetection && this.TrendFromITF && this.Symbol != null)
            {
                ...
                {
                    Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.ITFTrendInit");
                }
            }
        ...
        private void OnPositionRemoved_Handler(Position position)
        {
            ...
            {
                try { Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnPositionRemoved_Handler"); } catch { }
            }
        }
                                    ...
                                    lock (this.tradesLock)
                                    {
                                        ...
                                        catch (Exception exTrend)
                                        {
                                            Core.Instance.Loggers.Log(
                                                exTrend, "TradePhantoms_IOF_v3.TrendOnBarClose");
                                        }
                                    }
                                }
                            }
        ...
        private TPAlerts.AlertsConfig BuildAlertsConfig()
        {
            return new TPAlerts.AlertsConfig
            {
                ...
                SourceName       = "TradePhantoms IOF v3"
            };
        }
        ...
        private void OnControlPointDetected_Handler(TradePhantomsIOF.Trend.ControlPoint cp)
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnControlPointDetected_Handler");
            }
        }
        ...
        private void OnPositionAdded_Handler(Position position)
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnPositionAdded_Handler");
            }
        }
        ...
        private void OnTrendBroken_Handler(TradePhantomsIOF.Trend.TrendBreakEvent ev)
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnTrendBroken_Handler");
            }
        }
            ...
            TradePhantomsIOF.Trend.TrendState newState)
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnTrendStateChanged_Handler");
            }
        }
        ...
        private void OnNewLast(Symbol symbol, Last last)
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnNewLast");
            }
        }
        ...
        private void RescanMTFZones()
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.RescanMTFZones.ITF");
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.RescanMTFZones.HTF");
        ...
        private void DetectAndFireLifecycleAlerts()
        {
            ...
            for (int i = 0; i < trades.Count; i++)
            {
                ...
                {
                    Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.DetectAndFireLifecycleAlerts");
                }
        ...
        private void FireZoneDetectedAlerts()
        {
            ...
            for (int i = 0; i < this.zones.Count; i++)
            {
                ...
                {
                    Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.FireZoneDetectedAlerts");
                }
            }
        }
        ...
        private double EstimateTargetPrice(IofZone z, bool isDemand)
        {
            ...
            if (this.volumeAnalysisLoaded && this.HistoricalData != null)
            {
                ...
                {
                    Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.EstimateTargetPrice.VA");
                }
            }
        ...
        public override void OnPaintChart(PaintChartEventArgs args)
        {
            ...
            {
                Core.Instance.Loggers.Log(ex, "TradePhantoms_IOF_v3.OnPaintChart");
            }
            finally
            {
                gr.SetClip(prevClip);
